...
if page == "🏠 Dashboard":
    ...
    with q1:
        st.markdown('<div class="ppai-card">🗺️ <b>Roadmap Generator</b><br><span class="ppai-sub">Get a personalized 12-week plan</span></div>', unsafe_allow_html=True)
    with q2:
        st.markdown('<div class="ppai-card">📅 <b>Study Planner</b><br><span class="ppai-sub">Turn your roadmap into a weekly schedule</span></div>', unsafe_allow_html=True)
    with q3:
        st.markdown('<div class="ppai-card">🎯 <b>Goals & Progress</b><br><span class="ppai-sub">Track what you\'re working on</span></div>', unsafe_allow_html=True)
